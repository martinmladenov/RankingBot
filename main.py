from commands import clearrank_command, ranks_command, setrank_command, help_command, setofferdate_command, \
    toggleprivaterank_command, sendaccepteddm_command, sendreminderdm_command, addmanualdate_command, offers_command
...
bot.add_cog(sendreminderdm_command.SendreminderdmCommand(bot))
